...
if st.session_state.current_tab == 'home':
    ...
    with cols1[1]:
        with st.container(border=True):
            st.image('Image/dani.png', use_container_width=True)  # Gambar Portrait
            st.markdown(
                """
                <div style="
                    padding: 15px; 
    ...
    with cols1[2]:
        with st.container(border=True):
            st.image('Image/faris.png', use_container_width=True)  # Gambar Portrait
            st.markdown(
                """
                <div style="
                    padding: 15px; 
    ...
    with cols2[0]:
        with st.container(border=True):
            st.image('Image/reza.png', use_container_width=True)  # Gambar Portrait
            st.markdown(
                """
                <div style="
                    padding: 15px; 
